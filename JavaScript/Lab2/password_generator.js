...
function generator(password_length) {
    ...
    while (i < password_length) {
        ...
        let randomCharacter = possibilities[randomIndexSelector]// randomCharacter will now reach into the possibilities string, and pull out the character at our random index.
