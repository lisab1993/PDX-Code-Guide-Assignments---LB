...
book_words = {}#the words are the keys, and the counts are the values.
...
for i in range(min(100, len(pairs))):#iterate over the tuples within the pairs variable. After we have the first ten tuples, we want to stop.
